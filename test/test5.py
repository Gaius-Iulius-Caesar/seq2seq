...
def get_datas(file="D:/JetBrains/Python Files/seq2seq/data/translate.csv", nums=None):
...
if __name__ == "__main__":
    ...
    with open("D:/JetBrains/Python Files/seq2seq/data/ch.vec", "rb") as f1:
        _, ch_word_2_index, ch_index_2_word = pickle.load(f1)

    with open("D:/JetBrains/Python Files/seq2seq/data/en.vec", "rb") as f2:
