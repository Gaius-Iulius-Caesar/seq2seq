...
en_path = "data/news-commentary-v12.zh-en_en.en"
cn_path = "data/news-commentary-v12.zh-en_zh.zh"
...
class Encoder(nn.Module):
    ...
    def forward(self, batch_x, lengths):
        ...
        out, _ = nn.utils.rnn.pad_packed_sequence(packed_out,
                                                  batch_first=True)  # [batch_size, sentence_len, hidden_size]
...
def en2cn_translate(sentence_id):
    ...
    for word in translation:
        if (word != "EOS"):
            ...
            break
    print("source: ", en_sentence)
    print("target: ", cn_sentence)
    print("predict: ", ' '.join(trans))


L1 = random.sample(range(1, MAX_LEN), 5)
for i in L1:
    en2cn_translate(i)
